...
import { Payment } from "@/types/prisma/browser";
          ...
          <TableBody>
            {payments.map((payment) => (
              <TableRow key={payment.id} className="h-16">
                ...
                <TableCell>
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-semibold border ${payment.paymentStatus === "Paid" ? "bg-green-100 text-green-800 border-green-300" : "bg-yellow-100 text-yellow-800 border-yellow-300"}`}
                  >
